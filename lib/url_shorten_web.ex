defmodule UrlShortenWeb do
  ...
  def controller do
    quote do
      ...
      alias UrlShortenWeb.Router.Helpers, as: Routes
    end
  end
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/url_shorten_web/templates",
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {UrlShortenWeb.LayoutView, "live.html"}
  ...
  defp view_helpers do
    quote do
      ...
      import UrlShortenWeb.LiveHelpers
